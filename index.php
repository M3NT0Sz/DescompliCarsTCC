                    ...
                    <div class="ComenQuad">
                        <div class="ComenBar">
                            <div class="ComenEsq">
                                ...
                                ?>
                                    <input type="hidden" name="ExcComenCar" value="ExcComenCar">
                                <?php
                                    echo "<input type=hidden name='cod' value='$codigoopn'>";
                                    echo "<button class=button-7>Excluir</button>";
                                    echo "</form>";
                                }
                                ?>
                            </div>
            ...
            <div class="EditComenQuad">
                ...
                ?>
                    <div class="QuadEditComen">
                        ...
                        <form action="tudo.php" method="post">
                            <input type="hidden" name="ExcComen" value="ExcComen">
                            <input type="hidden" name="codigoopn" value="<?php echo $codigoopn; ?>">
                            <button class="button-7" style="margin-top: 20px;">Excluir Comentario</button>
                        </form>
                    </div>
            </div>
        <?php
